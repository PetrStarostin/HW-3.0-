...
// Console.WriteLine($"Input nummer {randNumber} max number {GetMaxNumber(randNumber)}");

//Напишите программу, которая принимает на вход число и проверяет, кратно ли оно одновременно a и b.(bool)
